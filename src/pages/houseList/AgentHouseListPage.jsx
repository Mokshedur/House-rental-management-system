  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <Link className="btn btn-primary" to={"/_/agent/add-house"}>
          Add House
        </Link>
      </div>
      <div>
        <ul>
          <div className="overflow-x-auto w-full">
            <table className="table w-full">
              ...
              <tbody>
                {houses
                  .filter((e) => RegExp(search.keyword, 'i').test(e[search.searchBy]))
                  .map((house, i) => {
                    return (
                      <tr key={i}>
                        <td>
...
export default AgentHouseListPage;
